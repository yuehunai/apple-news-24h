...
- Do not treat official Apple Card, Apple Pay, App Store, Apple services, or Apple retail/customer acquisition promotions as routine deal posts when they reveal a new or materially changed Apple business offer; include enough terms, eligibility, value, timing, and uncertainty details. Treat Apple official accessory availability changes, including Apple Store removal, regional unavailability, discontinuation, or suspected discontinuation, as hardware/product news rather than routine retail or third-party market background. Keep routine third-party accessory or consumer-electronics stories that only mention Apple-platform compatibility out of the final brief unless Apple/Beats, an official Apple accessory, an unreleased first-party hardware detail, or a direct Apple platform action is the subject.

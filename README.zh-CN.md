...
- 新增 Apple 官方隐私宣传处理，使 iPhone、App Store、权限、App 隐私标签和 App 跟踪透明度相关的一方广告保留在 `events` 中。
- 改进带摄像头 AirPods、iPhone 图像传感器供应商、iPhone 电池容量、Apple Watch 表带传感器，以及 Apple 芯片代工/制程报道的硬件传闻和泄密边界。
- 改进塔塔供应商数据泄露调查、Apple Watch 表带传感器传闻、iOS 点版本内部测试、Prosser 诉讼回应，以及 Apple 芯片代工否认报道的跨源聚类。
- 收紧购买指南、愿望清单/观点稿、第三方定制未发布 iPhone 概念、非 Apple 处理器评测、跑分对比和多厂商路线图报道的弱相关过滤。
- 更新兜底策略说明和回归测试，覆盖隐私广告、供应商数据泄露、OS 内部测试边界、硬件传闻拆分、芯片制程报道和弱 Apple 邻近噪音。

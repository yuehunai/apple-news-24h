...
- 新增 IT之家 `IT早报` 来源级过滤，在候选发现阶段跳过每日链接汇总，同时保留 IT之家独立 Apple 正文报道的收录资格。
- 改进 Apple 产品涨价聚类，将经销商或零售商对既有订单追补差价的争议，与 Apple 官方涨价和供应商成本转嫁报道拆开。
- 改进非 Apple 主体涨价跟随传闻的弱相关过滤，包括仅把 Apple 当作市场背景的第三方无人机或竞品调价消息。
- 优化涨价主题 facet 选择，使标题主导的 Apple 价格事件保留具体细分锚点，避免无关的成本、供应商或零售动作被合并。
- 增加 IT之家早报过滤、经销商追补差价和非 Apple 涨价跟随处理的兜底规则说明与回归测试。

...
- 改进 Apple 救灾捐款以及 Apple Books / App Store 平台信任类报道的候选相关性，包括 AI 生成仿冒、欺诈、版权和审核/治理问题，即使正文只把其他商店作为背景提及也不会被硬排除。
- 按产品家族细化硬件路线图聚类，使 MacBook/M 系列、iPhone/A 系列内存、未来 iPhone 价格预测、智能戒指传闻和宽泛 Apple silicon 时间线保持独立，除非它们描述同一 Apple 产品动作。
- 将官方翻新店或零售上架与 Apple 产品涨价/成本压力聚类拆开，同时保留当前涨价、Micron 或供应商背景、Apple 回应以及内存/存储短缺事实到正确的涨价事件中。
- 新增 Apple 公司组织事件处理，能合并高管离职和 OpenAI 挖角报道，同时避免 CEO、Gurman/Bloomberg、产品设计或工业设计背景把硬件路线图误分类为组织变化。
- 增加救灾捐款发现、Apple Books 平台信任、9to5Mac 尾部促销清理、智能戒指路线图相关性、多厂商芯片背景降级、产品家族聚类边界，以及零售/涨价拆分的回归测试。

...
- 改进第三方应用上线、非 Apple 主体的公益或采购消息，以及仅提到 Apple 硬件或平台的前 Apple 人士评论等弱相关过滤。
- 改进 M6 Mac 路线图、iPhone 18 Pro 逻辑板 / 主板泄露，以及 iPhone 18 Pro 电池容量报道的硬件聚类。
- 保持 Broadcom 供应协议作为独立硬件供应链事件，避免并入无关的 M 系列或 iPhone 传闻聚类。
- 更新直接 Apple 硬件传闻、非 Apple 平台可用性、公益 / 采购背景和前 Apple 人士背景的兜底策略说明。
- 增加上述弱相关和硬件聚类边界的回归测试。

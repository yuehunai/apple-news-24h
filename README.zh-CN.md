...
- 新增第一方复合路线图和项目的分解能力，覆盖 Apple Upgrade、智能家居硬件、Apple 服务内容及高管战略或交接报道，避免宽泛来源文章桥接相互独立的产品动作。
- 改进按同一动作归并的规则，区分具体机构的分析师评级和目标价、Apple 财报与市值、产品销量与市场份额、供应约束、供应商商业展望或采购，以及不同的 iPhone Air、iPhone 18、iPhone 18e 路线图和价格报道。
- 改进 Shazam、CarPlay、Beats 工程、AppleCare 方案变化、官方翻新产品、安全致谢和具名高管表态等直接 Apple 事项的相关性判断，同时让第三方应用、投票、播客、个人轶事、旧传闻汇总、无来源前瞻和竞品主导的行业预测保持弱相关。
- 新增具名来源报道和高管任期回顾的跨语言事件身份，仅在高管姓名、任期或周年及具体回顾动作一致时合并，并保持不同高管、不同任期、当前战略表态和无关公司里程碑相互独立。
- 改进来源清理及标题/导语归属判断，使用 URL 路径边界过滤并保留 Safari Technology Preview 页面，同时新增 9to5Mac `My top deals` 尾部截断，在不削薄正文事实的情况下移除推广价格。
- 更新 skill 与手动兜底说明，并将回归测试从 763 项增加到 829 项；并行联网验证保留全部 59 个已发现来源 URL、没有聚类警告，运行时间与基线一致。

...
- 新增 Apple 灾害救援承诺、Apple TV 命名内容版权收购、具体型号与日期的预购排期，以及已成交 Apple 历史藏品拍卖的结构化跨语言事件身份。
- 改进动作归属和内容形态边界，使仅兼容 Apple Home 的第三方产品、第一人称体验或升级动机文章及多年传闻汇总继续留在延后队列，同时保留当前版本系统变化和 Apple Store 官方结账或分期选项的纳入资格。
- 改进 Apple TV 版权报道和预购时间报道的事件协调，即使不同来源附带的产品背景不同也能正确归并，同时避免重新打开宽泛产品、平台或发布时间聚类。
- 改进灾害救援关键事实过滤及尼泊尔、西藏地区归一化，保留受灾地区和援助细节，并排除无关的管理层、接班、社交账号及沟通评论。
- 更新兜底规则并将回归测试由 1,254 项增加到 1,264 项；并发联网验证在 71.59/76.88 秒内保持发现、详情选择、文章数量及全部 47 个来源 URL 一致，纯净子代理验证生成 17 个独立主事件、零条合并警告，且无需从延后队列提升事件。

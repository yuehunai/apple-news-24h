...
- 改进周报/汇总页边界，使 MacRumors Top Stories 这类宽泛周报保持弱相关，同时让具体硬件报道继续作为独立事件保留。
- 改进中文文章结束标记、相关文章区块，以及 9to5Mac Apple @ Work 赞助/about 模板在摘要、关键事实和聚类抽取前的清理。
- 更新教程和找回设备提示、前 Apple 经历背景、无新 Apple 行动的赞助栏目，以及 AI 手机 / AI PC 泛市场评论的弱相关处理。
- 保持来源发现覆盖不变，同时把低价值误入项移入 `deferred_events` 供复核，避免污染最终简报清单。
- 更新兜底策略说明和回归测试，覆盖汇总页拆分、文章尾部清理、赞助模板、找回设备提示、前 Apple 背景和泛市场评论。

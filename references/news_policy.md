...
- Hardware and accessories: iPhone, iPad, Mac, Apple Watch, AirPods, Vision Pro, HomePod, official accessories, Apple silicon, modems, displays, cameras, and supply-chain production shifts. Include Apple official accessory availability changes such as Apple Store removal, regional unavailability, discontinuation, or suspected discontinuation, and treat them as hardware/product news even if the article mentions third-party headset, glasses, or broader market context.

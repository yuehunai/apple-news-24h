...
- Apple hardware launch, roadmap, or rumor stories remain hardware/product news when the subject is an Apple device and the material details are design, display, camera, chip, modem, sensor, battery, Touch ID/Face ID, storage, or release timing, even if the article also discusses health, Apple Intelligence, Siri, OS support, or other software-adjacent capabilities. Apple product price increases, component-cost pressure, memory/storage shortages, and supply-cost pass-through stories are also hardware/product news, not software/system news.
...
Hardware market and supply-chain reports must also stay split by concrete subject and action. Display-panel/OLED mass-production stories, broad multi-product panel allocation/orders, single-product foldable-iPhone panel production, foldable-iPhone supply timing, Apple design-team/company-organization changes, Apple product price/cost-pressure stories, and competitor product comparisons are separate event families unless the same source explicitly reports them as one Apple action for the same product scope. Weak or non-Apple-subject articles without a clear Apple action should not be absorbed into a stronger Apple hardware event just because they share generic words such as display, chip, price, Pro, production, supply, privacy, or design.
